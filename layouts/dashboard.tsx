    ...
    return <>
        <DashboardContext.Provider value={{ refetch: fetching, setMainAnimate, mainAnimate }}>
            <div className="flex flex-col min-h-screen ">
                ...
                <div className="flex">
                    <div className='w-[14%] 2xl:w-[15%] 3xl:w-[15%]'>
                        <Sidebar />
                    </div>
                    <main key={router.asPath} id='main' className={`relative w-[86%] 2xl:w-[85%] 3xl:w-[85%] transition-all pt-[3rem] overflow-y-hidden h-screen`}>
