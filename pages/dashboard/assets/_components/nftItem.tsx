...
import { SelectBlockchain, SelectFiatPreference, SelectFiatSymbol } from "redux/slices/account/remoxData";
    ...
    <div className="h-full w-full shadow-custom rounded-md bg-white dark:bg-darkSecond ">
      ...
      <div className="flex justify-between items-center  py-4 px-3">
          ...
          <div className="flex  items-center gap-3 justify-center">
              <div className="text-2xl font-semibold flex" ref={setDivRef}>
                <RiFileCopyLine className="cursor-pointer mr-3" onClick={() => {
