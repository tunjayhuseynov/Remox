                                ...
                                <div>
                                    <div className="flex items-center gap-2 text-greylish py-2">
                                        <span className="text-2xl font-bold flex items-center gap-1">
                                            <img src={GetCoins[coin.coin].logoURI} className="w-4 h-4 rounded-full" alt="" />{SetComma(coin.totalUsedAmount)}</span>impacted on<span className="text-lg flex items-center gap-1">
                                            <img src={GetCoins[coin.coin].logoURI} className="w-4 h-4 rounded-full" alt="" />{SetComma(coin.totalAmount)}</span>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-4 px-3 justify-between items-center py-4">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <div className="flex items-center gap-1 font-bold"><img src={GetCoins[item.budgetCoins.coin].logoURI} className="w-4 h-4 rounded-full" alt="" />{SetComma(coin.totalUsedAmount)}</div>
                                        </div>
                                        <div className="flex flex-col gap-2">
                                ...
                                {coin.second && <>
                                    <div>
                                        ...
                                        <div className="grid grid-cols-4 px-3 justify-between items-center py-4">
                                            ...
                                            <div className="flex flex-col gap-2">
                                                <div className="flex items-center gap-1 font-bold"><span className={`rounded-full stripe-1 bg-primary p-2 font-bold`}></span>Pending</div>
                                                <div className="flex items-center gap-1 font-bold"><img src={GetCoins[coin.second.secondCoin].logoURI} className="w-4 h-4 rounded-full" alt="" />{SetComma(coin.second.secondTotalPending)}</div>
                                            </div>
                                            <div className="flex flex-col gap-2">
                                                <div className="flex items-center gap-1 font-bold"><span className={`rounded-full bg-gray-500 p-2 font-bold`}></span>Available</div>
                                                <div className="flex items-center gap-1 font-bold"><img src={GetCoins[coin.second.secondCoin].logoURI} className="w-4 h-4 rounded-full" alt="" />{SetComma(coin.second.secondTotalAmount - coin.totalUsedAmount)}</div>
                                            </div>
                                        </div>
                                    </div>
                                </>}
                                    ...
                                    <div className="border-b py-4 w-full flex justify-between items-center">
                                        ...
                                        <div className='flex flex-col space-y-2'>
                                            ...
                                            {item.budgetCoins.second && <div className="text-greylish flex items-start gap-1 text-sm">
                                                ...
                                                <span className="text-red-600">{item.budgetCoins.second.secondTotalAmount}</span>
                                                <span>/</span>
                                                <img src={GetCoins[item.budgetCoins.second.secondCoin].logoURI} className="w-5 h-5 rounded-full" alt="" />
                                                <span className="text-greylish">{item.budgetCoins.second.secondTotalUsedAmount}</span>
                                                <span>/</span>
                                                <img src={GetCoins[item.budgetCoins.second.secondCoin].logoURI} className="w-5 h-5 rounded-full" alt="" />
                                                <span className="text-greylish">{item.budgetCoins.second.secondTotalPending}</span>
                                            </div>}
                                        </div>
