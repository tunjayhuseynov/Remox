...
const BudgetDetails = forwardRef<HTMLDivElement, IProps>(({ item, close, visibility }, ref) => {
    ...
    const usedSecondPercent = useMemo(() => (coin.second?.secondTotalUsedAmount ?? 0) * 100 / (coin.second?.secondTotalAmount ?? 1), [item])
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-4 px-3 justify-between items-center py-4">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-1 font-bold"><img src={GetCoins[item.budgetCoins.coin].coinUrl} className="w-4 h-4 rounded-full" alt="" />{coin.totalPending}</div>
                            </div>
                            <div className="flex flex-col gap-2">
                        ...
                        {item.budgetCoins.second && <>
                            ...
                            <div className=" rounded-xl relative w-full h-[1.2rem] flex bg-greylish bg-opacity-40">
                                ...
                                <div className=" h-full bg-greylish"></div>
                                <div className=" h-full bg-greylish bg-opacity-10 rounded-r-xl"></div>
                            </div>
