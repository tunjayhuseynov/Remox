...
const Delete = ({ name, loading, onCurrentModal, onDelete, onSuccess }: { name: string, loading:boolean ,onCurrentModal: Dispatch<boolean>, onDelete: () => Promise<void>, onSuccess?: Dispatch<boolean> }) => {
    return <div className="flex flex-col space-y-10 items-center">
        ...
        <div className="flex justify-center items-center space-x-4">
            ...
            <Button className=" w-[7rem] h-[3rem] !px-1 !py-0 rounded-lg" onClick={() => onDelete()} isLoading={loading}>Yes</Button>
        </div>
    </div>
}
