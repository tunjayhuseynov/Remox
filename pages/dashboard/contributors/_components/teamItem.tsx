          ...
          <div className="grid grid-cols-[70%,30%] items-center w-full">
            <div className="">
              <EditableTextInput
                ...
                onSubmit={onWorkstreamNameChange}
                placeholder="Individual account name"
              />
            </div>
            <div className="flex items-center justify-end curs">
              <RiDeleteBin6Line
                className="h-8 hover:text-primary transition-all "
            ...
            {props.members.slice(0, 9).map((member, index) => {
              return (
                <img
                  ...
                  className={`absolute bottom-0 border w-8 h-8 rounded-full`}
                  style={{
