...
import { selectMultisigTransactions } from "redux/slices/account/multisig"
...
const MultisigTransaction = () => {
    ...
    if (!transactionData) {
        return <div className="w-full h-screen flex items-center justify-center"> <div><Loader /></div></div>
    }
    ...
    return <div className="flex w-[60%] my-14 mx-auto">
        <div className="flex flex-col w-full space-y-10 flex-wrap">
            ...
            <div className="flex justify-center space-x-5">
                <div>
                    <Button version="second" className="px-5 !py-2 w-[7.813rem]" onClick={() => history.back()}>
                        Back
                    </Button>
                </div>
