      ...
      <table className="w-full pt-1 pb-4 ">
        <thead>
          ...
          <tr id="header" className={`grid  grid-cols-[18.5%,9.5%,9.5%,13.5%,14.5%,12.5%,9.5%,12.5%] bg-[#F2F2F2] shadow-15 py-2 px-3 dark:bg-darkSecond rounded-md`} >
            ...
            <th className=" text-sm text-center font-semibold text-greylish dark:text-[#aaaaaa]">Progress</th>
            <th className=" text-sm text-left font-semibold text-greylish dark:text-[#aaaaaa] ">Amount</th>
