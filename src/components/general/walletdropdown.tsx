...
const Li = ({ children }: { children: JSX.Element[] | JSX.Element}) => <li className="navbarli text-left flex gap-5 border-b-2 transition  px-5 py-4 bg-white dark:bg-darkSecond   cursor-pointer first:rounded-t-xl last:rounded-b-xl"> {children}</li>
