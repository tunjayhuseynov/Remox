    ...
    return <>
        <div className="flex flex-col mb-4 space-y-1 w-full">
            ...
            <div className={`${className} flex items-center gap-3 w-full`}>
                <input type={type} name={name} autoComplete='new-password' minLength={limit} className="bg-greylish dark:bg-darkSecond bg-opacity-10 h-[2.188rem] rounded-lg w-full px-1" onChange={(e) => {
