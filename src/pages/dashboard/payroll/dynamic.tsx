...
export default function DynamicPayroll({ type }: { type: "manual" | "auto" }) {
    ...
    return <>
        ...
        <div className="w-full shadow-custom px-5 pt-4 pb-6 rounded-xl">
            <div id="header" className="hidden sm:grid grid-cols-[30%,30%,1fr] lg:grid-cols-[20%,20%,20%,20%,1fr] border-b border-black sm:pb-5 px-5" >
                ...
                <div className="font-normal">End Payment</div>
            </div>
            <div>
