    ...
    return <div className="flex items-center justify-center pt-12">
        <div className="flex flex-col w-[80%]">
            <div className="shadow-custom rounded-xl bg-white dark:bg-darkSecond pt-3 pb-10 px-3 flex flex-col space-y-1">
                ...
                <div className="bg-greylish bg-opacity-10 h-[100px] items-center flex justify-between rounded-md py-3 px-3">
                    <div className="flex flex-col space-y-2 w-[130px]">
                        ...
                        <div>
                            <input ref={token1Input} onChange={async (e) => { setToken1Amount(parseFloat((e.target.value))); await change(parseFloat((e.target.value))); }} type="number" className="bg-transparent text-center outline-none font-bold text-2xl unvisibleArrow max-w-[130px]" placeholder="0" min="0" step="any" />
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-center">
                    <div className="bg-greylish  bg-opacity-10 px-3 my-2 py-1 rounded-lg cursor-pointer" onClick={changeSwap}>
                        <img src="/icons/arrowdown.svg" className="dark:invert dark:brightness-0" alt="" />
                    </div>
                </div>
                <div className="flex bg-greylish h-[100px] bg-opacity-10 justify-between rounded-md py-3 px-3">
                    <div className="flex flex-col space-y-2 w-[130px]">
                        <div>
                            <Dropdown onChange={(w: DropDownItem, selected: DropDownItem) => {
