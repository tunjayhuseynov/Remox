...
function BudgetCard({ setEditBudget, setDelBudget, item, }: { item: IBudgetORM, setEditBudget: React.Dispatch<boolean>, setDelBudget: React.Dispatch<boolean> }) {
                ...
                <div>
                    ...
                    <div className="grid grid-cols-4 px-3 gap-4 justify-between items-center py-4">
                        <div className="flex flex-col gap-2">
                            ...
                            <div className="flex items-center gap-1 font-bold"><img src={GetCoins[coin.coin].coinUrl} className="w-4 h-4 rounded-full" alt="" />{coin.totalUsedAmount}</div>
                        </div>
                        <div className="flex flex-col gap-2">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-1 font-bold"><span className={`rounded-full bg-gray-500 p-2 font-bold`}></span>Availabel</div>
                    ...
                    {coin.second && <>
                        ...
                        <div className="flex items-center gap-2 text-greylish dark:text-white py-4"><span className="text-2xl font-bold flex items-center gap-1 dark:text-white">
                            <img src={GetCoins[coin.second.secondCoin].coinUrl} alt="" className="rounded-full" />{coin.second.secondTotalUsedAmount}</span>impacted on<span className="text-lg flex items-center gap-1 ">
                                <img src="/icons/currencies/celodollar.svg" className="rounded-full" alt="" />{coin.second.secondTotalAmount}</span>
                        </div>
                        <div className=" rounded-xl relative w-full h-[1.2rem] flex    bg-greylish bg-opacity-40">
                        ...
                        <div className="grid grid-cols-4 px-3 justify-between items-center py-4">
                            <div className="flex flex-col gap-2">
                                <div className="flex items-center gap-1 font-bold"><span className={`rounded-full bg-primary p-2 font-bold`}></span>Used</div>
                                <div className="flex items-center gap-1 font-bold"><img src={GetCoins[coin.second.secondCoin].coinUrl} className="w-4 h-4 rounded-full" alt="" />{coin.second.secondTotalUsedAmount}</div>
                            </div>
                        </div>
                    </>}
                </div>
