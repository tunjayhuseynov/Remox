...
function TotalValues({ total }: { total: IBudgetExerciseORM }) {
    ...
    return <div className="py-4  border-b dark:border-[#aaaaaa]">
        <div className='grid grid-cols-[35%,20%,20%,20%,5%]'>
            ...
            <div className={`flex px-20 border-r dark:border-[#aaaaaa] !my-0`}>
                <div className={`flex flex-col gap-12 lg:gap-4 `}>
            ...
            <div className={`flex !border-r-0 gap-8 !flex-row text-2xl min-w-[23rem] items-center justify-center dark:border-[#aaaaaa] !my-0`}>
