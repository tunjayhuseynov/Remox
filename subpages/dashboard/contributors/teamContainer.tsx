...
const TeamContainer = (props: (IuseContributor) & {selectbar:string}) => {
    ...
    return <>
       {props.selectbar === "Team" && <div className=" bg-white dark:bg-darkSecond rounded-lg px-3  shadow flex  py-2 pb-4  min-w-[23.5rem] min-h-[12rem] items-start justify-between pl-5">
            ...
            <div className="flex items-end justify-end">
                ...
                <div className="cursor-pointer hover:bg-greylish hover:bg-opacity-5 hover:transition-all text-sm border-b border-greylish border-opacity-20 flex items-center min-w-[8rem] px-2 pr-6 py-2 gap-2" onClick={() => setEditModal(true)}>
        ...
        {props.members && props.selectbar  !== "Team" &&  props.members.length > 15 && num !== 100 ? <button className="py-3 pb-5  font-bold text-primary" onClick={() => setNum(100)}>
            Show More
        </button> : null}
