...
const TeamItem = (props: IMember & { teamName: string, selectbar: string }) => {
    ...
    return <>
        ...
        {props.selectbar === "Active" ? <div className="grid grid-cols-2 sm:grid-cols-[30%,30%,1fr] lg:grid-cols-[17%,15%,19%,19%,17%,23%] text-center items-center py-6 border-b-2 border-greylish border-opacity-10 pb-5  text-sm relative">
            ...
            : props.selectbar === props.compensation && <div className="grid grid-cols-2 sm:grid-cols-[30%,30%,1fr] lg:grid-cols-[17%,15%,19%,19%,17%,23%] text-center items-center py-6 border-b-2 border-greylish border-opacity-10 pb-5  text-sm relative">
                <div className="pl-[2px] items-start">
                    <div className="hover:cursor-pointer flex items-center space-x-1" onClick={() => setModalVisible(true)}>
                        <Avatar name={props.name} />
