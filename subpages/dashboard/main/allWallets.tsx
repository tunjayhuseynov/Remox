...
function AllWallets({item,key,walletModal,setWalletModal}:{item:AllwalletTypes,key:number,walletModal:boolean,setWalletModal:React.Dispatch<React.SetStateAction<boolean>>}) {
  ...
  <div key={key} className="w-full shadow-custom  pt-4  rounded-xl bg-white dark:bg-darkSecond min-w-[50%]">
