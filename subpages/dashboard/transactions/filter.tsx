...
function Filter() {
  ...
  <div className="flex flex-col gap-3 p-2  border-r dark:border-black pt-5  h-full">
  ...
  <div className="flex flex-col w-full h-full">
     {filter === 0 &&<><div className="flex flex-col w-full h-full py-4 px-5 gap-2">
          ...
          <div className="flex items-center w-[45%]  gap-1">
              <div className="flex flex-col gap-1 w-full"> <span className="text-left text-sm text-greylish dark:text-white">From</span> <input type="date" className="w-full border rounded-lg p-1 outline-none bg-greylish bg-opacity-10 dark:bg-dark"  /></div>
              <div className="border w-full mt-3 h-[1px] dark:bg-dark"></div>
              <div className="flex flex-col  gap-1 w-full"> <span className="text-left text-sm text-greylish dark:text-white">To</span> <input type="date" className="w-full border rounded-lg p-1  outline-none bg-greylish bg-opacity-10 dark:bg-dark"   /></div>
          </div>
      </div></> }
      ...
      <div className="flex flex-col w-full h-full pb-2 px-5 gap-2">
          ...
          <div className="flex items-center  gap-2">
              <div className="flex flex-col gap-1"> <span className="text-left text-sm text-greylish dark:text-white">Min.</span> <input type="number" className="w-full border rounded-lg p-1 outline-none unvisibleArrow dark:bg-dark" placeholder="$0.0" /></div>
              <div className="border w-[100%] mt-3 h-[1px] dark:bg-dark"></div>
              <div className="flex flex-col  gap-1"> <span className="text-left text-sm text-greylish dark:text-white">Max.</span> <input type="number" className="w-full border rounded-lg p-1  outline-none unvisibleArrow dark:bg-dark" placeholder="$0.0"  /></div>
          </div>
      </div></> }
